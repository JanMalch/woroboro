...
object LinkifyTextDefaults {
    ...
    val darkThemeLinkColor = Color(168, 199, 250)
    val lightThemeLinkColor = Color(11, 87, 208)
...
fun LinkifyText(
    ...
    linkStyle: SpanStyle = LinkifyTextDefaults.linkStyle(),
...
private class SpannableStr(source: CharSequence) : SpannableString(source) {
    companion object {
        fun getLinkInfos(text: String): List<LinkInfo> {
            ...
            // Change: using WEB_URLS and not (deprecated) ALL
