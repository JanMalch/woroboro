...
data class ExerciseExecution(
    ...
    val sets: Int,
    /**
     * The amount of repetitions for this execution of the exercise. Either [reps] or [hold] should
     * be defined.
     */
    val reps: Int?,
    /**
     * The duration to hold the exercise for this execution. Either [reps] or [hold] should be
     * defined.
     */
    val hold: Duration?,
...
fun CustomExerciseExecution.asExerciseExecutionOrNull(): ExerciseExecution? {
    return ExerciseExecution(sets = sets ?: return null, reps = reps, hold = hold, pause = pause)
}

fun ExerciseExecution.asCustomExecution(): CustomExerciseExecution {
    return CustomExerciseExecution(sets = sets, reps = reps, hold = hold, pause = pause)
}
